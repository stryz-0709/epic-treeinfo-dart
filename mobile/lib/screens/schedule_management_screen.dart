      ...
      appBar: AppTopToolbar(
        ...
        trailing: IconButton(
          onPressed: scheduleProvider.isLoading
              ? null
              : () {
                  scheduleProvider.retryLoad(authProvider: authProvider);
                },
                              ...
                              child: RefreshIndicator(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final parsedDay = scheduleProvider
                                        .parseWorkDate(item.workDate);
                                    final rangerDisplayName = scheduleProvider
